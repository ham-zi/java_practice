...
public class FootballPlayer {
	...
	public FootballPlayer(String name, Position position, Integer backNumber) {
		...
		if (backNumber <= 0) {
			throw new IllegalArgumentException("등번호는 0보다 크거나 같아야합니다.");
		}
	...
	public FootballPlayer(int id, String name, Position position, Integer backNumber) {
		this.id = id;
		this.name = name;
		this.position = position;
		this.backNumber = backNumber;
